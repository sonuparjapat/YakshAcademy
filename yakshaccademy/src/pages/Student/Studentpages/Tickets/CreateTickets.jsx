...
import { Alarm, Assignment, Home } from '@mui/icons-material'
...
const [ticketdata,setTicketdata]=useState(initialvalue)

const {token,field,unqId,type,username,useremail}=logindata
useEffect(()=>{
setTicketdata((pre)=>({...pre,username,field,useremail,unqId,type}))
},[])

const handlechange=(e)=>{
    const {name,value}=e.target
    setTicketdata((pre)=>({...pre,[name]:value}))
}
const handlesubmit=(e)=>{
  ...
  return (
    <>
     <Box  border={"1px solid gray"} w="90%" margin={"auto"} p={2} mt="10px">
    <Flex
                ...
                <VStack spacing={5}>
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      <Input type="text" onChange={handlechange} isDisabled value={ticketdata.username}  name="username" placeholder="Your Name" />
                    </InputGroup>
                  </FormControl>
                  ...
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      <Input type="useremail"onChange={handlechange} isDisabled value={ticketdata.useremail} name="email" placeholder="Your Email" />
                    </InputGroup>
                  </FormControl>
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      <Input type="text" onChange={handlechange} isDisabled value={ticketdata.type}   name="type" placeholder="type" />
                    </InputGroup>
                  </FormControl>
                  ...
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      <Input type="text"onChange={handlechange} isDisabled value={ticketdata.field} name="field" placeholder="Your field" />
                    </InputGroup>
                  </FormControl>
                  <FormControl isRequired>
                    <FormLabel>UniqueId</FormLabel>

                    <InputGroup>
                      <InputLeftElement>
                        <BsPerson />
                      </InputLeftElement>
                      <Input type="text" isDisabled onChange={handlechange} value={ticketdata.unqId}  name="unqId" placeholder="Your Id" />
                    </InputGroup>
                  </FormControl>
